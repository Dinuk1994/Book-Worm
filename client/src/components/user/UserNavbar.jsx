  ...
  return (
    <div className="bg-gray-700 h-16">
      <div className="grid grid-cols-12 tablet:grid-cols-7 mobile:grid-cols-3 h-full ">
        ...
        <div className="mobile:col-span-1  flex items-center">
            ...
            <div className="dropdown dropdown-end">
              <div className="dropdown dropdown-end">
                ...
                <ul
                  ...
                  <li className="desktop-or-laptop:hidden"><a>{user?.userName}</a></li>
                  <li className="desktop-or-laptop:hidden"><a>Bookmarks</a></li>
                  <li className="desktop-or-laptop:hidden"><a>Suggestions</a></li>
                  <li className="desktop-or-laptop:hidden"><a>Logout</a></li>
                  <li><a>Settings</a></li>
                  <li><a>Logout</a></li>
                </ul>
              </div>
