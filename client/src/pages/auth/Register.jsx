    ...
    <div>
      <div className="p-8 mobile:p-2 mb-10">
        <div className="grid justify-center">
          <label className="text-5xl font-semibold text-white mobile:text-gray-800" htmlFor="">Register</label>
        </div>
        <form className="grid gap-y-7 mt-7 px-10" action="">
        <div>
            <label className="text-white text-lg" htmlFor="">Enter Fullname</label>
